package com.tsingtech.gateway.exception.conf;

import com.tsingtech.gateway.exception.handler.JsonExceptionHandler;
...
public class ErrorHandlerConf {
    ...
    public ErrorHandlerConf(ServerProperties serverProperties,
